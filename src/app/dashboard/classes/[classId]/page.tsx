  ...
  return (
    <div style={{ maxWidth: '900px' }}>
      <div style={{ marginBottom: '2rem' }}>
        <Link href="/dashboard/classes" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.375rem', fontSize: '0.875rem', color: '#64748b', textDecoration: 'none', marginBottom: '1rem', fontWeight: '600' }}>
          ...
          {isTeacher ? (
            <>
              <div className="stat-card" style={{ padding: '1.5rem', background: 'linear-gradient(135deg, #4f46e5, #6366f1)', color: '#fff' }}>
                ...
                <Link href="/dashboard/practice" style={{ display: 'block', textAlign: 'center', padding: '0.75rem', background: '#fff', color: '#4f46e5', fontWeight: '700', borderRadius: '0.5rem', fontSize: '0.875rem', textDecoration: 'none' }}>
                  Go to Test Bank
                </Link>
              </div>
            </>
